...
const ProductInfo = (props) => {
  return (
    <div className="product-info-container">
      <Helmet>
        <title>Product-Info - MARTCUHK</title>
        <meta property="og:title" content="Product-Info - MARTCUHK" />
      </Helmet>
      <div className="product-info-navbar">
        <header
          data-role="Header"
          className="product-info-header max-width-container"
        >
          <div className="product-info-navbar1">
            <div className="product-info-container01">
              <Link to="/search" className="product-info-navlink">
                <img
                  alt="search3271286"
              ...
              <input
                type="text"
                placeholder="search"
                className="product-info-textinput input"
              />
            </div>
            <div className="product-info-middle">
              ...
              <Link
                to="/"
                className="product-info-logo-center navbar-logo-title"
              >
                MARTCUHK
              </Link>
            ...
            <div className="product-info-icons">
              <Link to="/shopping-cart" className="product-info-navlink1">
                <img
              ...
              <img
                ...
                className="product-info-image3"
              />
            </div>
          </div>
          <div data-role="BurgerMenu" className="product-info-burger-menu">
            <svg viewBox="0 0 1024 1024" className="product-info-icon">
              <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
            </svg>
          </div>
          <div data-role="MobileMenu" className="product-info-mobile-menu">
            <div className="product-info-nav">
              <div className="product-info-container02">
                <span className="product-info-logo-center1">MOBILLIO</span>
                <div
                  data-role="CloseMobileMenu"
                  className="product-info-close-mobile-menu"
                >
                  <svg viewBox="0 0 1024 1024" className="product-info-icon02">
                    <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                  </svg>
                </div>
              </div>
              <div className="product-info-middle1">
                <span className="product-info-text06">SHOP</span>
                <span className="product-info-text07">LOOKBOOK</span>
                <span className="product-info-text08">SPECIAL</span>
                <span className="product-info-text09">ABOUT</span>
                <span className="product-info-text10">BLOG</span>
                <span className="product-info-text11">CONTACT</span>
              </div>
            </div>
            <div>
              <svg
                viewBox="0 0 950.8571428571428 1024"
                className="product-info-icon04"
              >
      ...
      <div className="product-info-main">
        <div className="product-info-trending-items section-container"></div>
      ...
      <div className="product-info-footer">
        <div className="max-width-container">
          <footer className="product-info-footer1">
            <div className="product-info-container10">
              <h3 className="product-info-text16 Heading-3">MARTCUHK</h3>
              <span className="product-info-text17">
                The Chinese University of Hong Kong, Ma Liu Shui, Shatin, Hong
                Kong
              </span>
              <span className="product-info-text18">(852) 1234-5678</span>
              <span className="product-info-text19">
                contact@cse.cuhk.edu.com
              </span>
            </div>
            <div className="product-info-links-container">
              <div className="product-info-container11">
                <span className="product-info-text20">Categories</span>
                <span className="product-info-text21">Collections</span>
                <span className="product-info-text22">Desks</span>
                <span className="product-info-text23">Furniture</span>
                <span className="product-info-text24">Lamps</span>
                <span className="product-info-text25">Plants</span>
                <span className="product-info-text26">Decoration</span>
              </div>
              <div className="product-info-container12">
                <span className="product-info-text27">Company</span>
                <span className="product-info-text28">Shop</span>
                <span className="product-info-text29">Lookbook</span>
                <span className="product-info-text30">Specials</span>
                <span className="product-info-text31">About</span>
                <span className="product-info-text32">Blog</span>
              </div>
              <div className="product-info-container13">
                <span className="product-info-text33">Resources</span>
                <span className="product-info-text34">Contact us</span>
                <Link to="/past-orders" className="product-info-navlink3">
                  Order
                </Link>
                <Link to="/track-order" className="product-info-navlink4">
                  Track your order
                </Link>
                <span className="product-info-text35">
                  Shipping &amp; Delivery
                </span>
              </div>
            </div>
