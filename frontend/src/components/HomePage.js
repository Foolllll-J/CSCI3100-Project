...
function Home() {
    return (
        <div className='main-container' style={{top: '14vh'}}>
            <div className='home-nav'>
                <div className='home-nav-logo-container'>
                    <img src='Full-Cart.svg' style={{height: '90%', width: '100%'}}></img>
                </div>
                ...
                <div className='home-nav-searchbox-container'>
                    <div class="input-group flex-nowrap" style={{width: '15vw', position: 'fixed', right: '3vw'}}>
