    ...
    <div className={`product-card-speaker-card ${props.rootClassName} `}>
      <div className="product-card-image-container">
        ...
        <div className="product-card-read-more-container">
          <span className="product-card-hint">read more</span>
      ...
      <span className="product-card-product-name">{props.productName}</span>
      <span className="product-card-product-id">carey</span>
      <span className="product-card-text">{props.productPrice}</span>
    </div>
  )
}
...
ProductCard.defaultProps = {
  rootClassName: '',
  imageAlt: 'image',
  productPrice: 'brand manager @ pepsi',
  imageSrc:
